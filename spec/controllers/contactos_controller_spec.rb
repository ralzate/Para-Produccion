...
RSpec.describe ContactosController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all contactos as @contactos" do
      ...
      expect(assigns(:contactos)).to eq([contacto])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested contacto as @contacto" do
      ...
      expect(assigns(:contacto)).to eq(contacto)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created contacto as @contacto" do
        post :create, {:contacto => valid_attributes}, valid_session
        expect(assigns(:contacto)).to be_a(Contacto)
        expect(assigns(:contacto)).to be_persisted
      end

      it "redirects to the created contacto" do
        post :create, {:contacto => valid_attributes}, valid_session
        expect(response).to redirect_to(Contacto.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved contacto as @contacto" do
        post :create, {:contacto => invalid_attributes}, valid_session
        expect(assigns(:contacto)).to be_a_new(Contacto)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested contacto" do
        contacto = Contacto.create! valid_attributes
        put :update, {:id => contacto.to_param, :contacto => new_attributes}, valid_session
        contacto.reload
    ...
    context "with invalid params" do
      it "assigns the contacto as @contacto" do
        contacto = Contacto.create! valid_attributes
        put :update, {:id => contacto.to_param, :contacto => invalid_attributes}, valid_session
        expect(assigns(:contacto)).to eq(contacto)
      end
